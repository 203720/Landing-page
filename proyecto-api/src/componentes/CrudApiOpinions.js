...
import  CrudFormOpinions  from './CrudFormOpinions';
import CrudTableOpinions from "./CrudTableOpinions";


const CrudApiOpinions = () => {
     ...
     let url= "http://localhost:5000/opinions";
...
export default CrudApiOpinions